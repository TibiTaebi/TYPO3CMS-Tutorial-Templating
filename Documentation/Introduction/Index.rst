...
The result of this tutorial is a site similar to the Introduction Package.
This tutorial includes a set of files (mainly an HTML file and a CSS file),
...
online version on https://docs.typo3.org/typo3cms/TemplatingTutorial/.
